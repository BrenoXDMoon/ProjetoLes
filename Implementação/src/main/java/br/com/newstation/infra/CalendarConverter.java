...
public class CalendarConverter implements Converter{
	...
	public CalendarConverter() {
		...
		converter.setTimeZone(TimeZone.getTimeZone("America/Sap_Paulo"));
	}
	...
	@Override
	public String getAsString(FacesContext context, UIComponent component, Object dataObejct) {
		if (dataObejct == null)
			return null;
		
		Calendar calendar = (Calendar) dataObejct;
