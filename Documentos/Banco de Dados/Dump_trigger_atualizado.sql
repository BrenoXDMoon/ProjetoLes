...
INSERT INTO `carta` VALUES (1,_binary '','Deck Inicial do Kaiba','cartas/blue-eyes.png','Dragão Branco de Olhos Azuis',80.00,'ultraRaro',2,'2021-01-11','Konami',10.00),(2,_binary '','Impacto do Caos','cartas/AromageMarjoram.webp','Aromágico Manjerona',1.89,'normal',3,'2021-01-11','Copag',0.50),(3,_binary '','O Poder do Duelo','cartas/AromageJasmine.webp','Aromágico Jasmim',51.00,'ultraRaro',4,NULL,'Copag',5.00),(6,_binary '','Impacto do Caos ','cartas/Manjerona-Doce.webp','Aromági-serafim Manjerona-Doce',0.99,'superRaro',5,NULL,NULL,0.00),(7,_binary '','Legendary Collection 4 ','cartas/Jinzo.webp','Jinzo',9.00,'raro',6,NULL,NULL,0.00),(8,_binary '','O Poder do Duelo ','cartas/alecrim.jpg','Aromágico Alecrim',32.00,'raro',7,NULL,NULL,0.00),(9,_binary '','Decks Lendários II ','cartas/forca_espelho.webp','Força do Espelho',6.00,'normal',8,NULL,NULL,0.00),(10,_binary '','Rugido do Dragão ','cartas/chamado_dos_mortos_vivos.webp','Chamado dos Assombrados',2.00,'normal',9,NULL,NULL,0.00),(12,_binary '','Decks Lendários de Yugi','cartas/Lustronegro001.JPG','Soldado do Lustro Negro',20.00,'superRaro',11,NULL,NULL,0.00),(13,_binary '','INVASÃO: VINGANÇA','cartas/alecrim-sincro.png','Aromági-serafim Alecrim ',1.50,'raro',12,NULL,NULL,0.00);
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `carta_BEFORE_INSERT` BEFORE INSERT ON `carta` FOR EACH ROW BEGIN
...
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `carta_BEFORE_UPDATE` BEFORE UPDATE ON `carta` FOR EACH ROW BEGIN
	if(new.ativo <> old.ativo or 
       ...
       new.valorCusto <> old.valorCusto) then
INSERT INTO `newstation`.`carta_log`
(`Id`,
`ativo`,
`descricao`,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `cartaocredito_BEFORE_INSERT` BEFORE INSERT ON `cartaocredito` FOR EACH ROW BEGIN
...
INSERT INTO `cartaopedido` VALUES (1,85.00,9),(2,5.99,6),(3,85.00,9),(10,76.89,9),(11,15.97,9),(12,0.76,9),(14,-5.00,11),(16,4.01,10),(17,7.12,9),(24,4.80,10),(26,6.50,10),(27,4.00,9),(28,-0.23,10),(32,5.39,10),(35,5.00,9),(36,NULL,10),(37,11.00,10),(38,600.00,10),(39,NULL,11),(40,85.00,10),(41,2349.12,10),(42,6.89,12),(43,800.00,10),(44,NULL,11);
...
INSERT INTO `cartapedido` VALUES (3,5,3),(4,10,6),(7,1,9),(10,1,2),(14,1,6),(15,1,1),(16,1,6),(18,1,1),(30,1,2),(31,1,1),(32,3,6),(33,0,7),(34,3,2),(35,0,6),(40,1,6),(41,0,2),(48,2,13),(50,0,13),(51,1,2),(52,1,7),(54,1,2),(56,1,13),(57,1,10),(58,0,2),(59,4,3),(60,9,1),(61,1,1),(62,11,7),(63,9,1),(64,1,2),(65,7,2),(66,6,1);
...
INSERT INTO `cliente_cartaocredito` VALUES (5,2),(10,4),(11,5),(11,6),(13,7),(1,9),(1,10),(1,11),(1,12);
...
INSERT INTO `cliente_documento` VALUES (5,2),(10,4),(13,6),(1,12),(1,13),(11,14);
...
INSERT INTO `cliente_endereco` VALUES (10,11),(11,12),(1,18),(1,19),(13,22),(1,23),(1,24),(1,25);
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `cupom_BEFORE_INSERT` BEFORE INSERT ON `cupom` FOR EACH ROW BEGIN
...
INSERT INTO `documento` VALUES (2,'1231863438','RG','2019-12-12'),(3,'18311548','RG','2019-12-12'),(4,'49176193861','CPF','2012-12-12'),(6,'73426312999','CPF','2012-12-12'),(8,'06415721402','CPF','2015-12-05'),(12,'06415721402','RG','2001-11-30'),(13,'06415721402','CPF','2015-12-01'),(14,'45185318384834','RG','2150-12-09');
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `documento_BEFORE_INSERT` BEFORE INSERT ON `documento` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `endereco_BEFORE_INSERT` BEFORE INSERT ON `endereco` FOR EACH ROW BEGIN
...
INSERT INTO `estoque` VALUES (2,67),(3,12),(4,112),(5,103),(6,48),(7,30),(8,30),(9,30),(11,30),(12,28);
...
INSERT INTO `pedido_cartaopedido` VALUES (6,1),(7,2),(9,3),(16,10),(17,11),(18,12),(20,14),(22,16),(23,17),(30,24),(32,26),(33,27),(33,28),(36,32),(38,35),(38,36),(39,37),(40,38),(40,39),(41,40),(42,41),(43,42),(44,43),(44,44);
...
INSERT INTO `pedido_cartapedido` VALUES (1,3),(1,4),(3,7),(6,15),(7,16),(9,18),(16,30),(16,31),(17,32),(17,33),(18,34),(18,35),(22,40),(23,41),(30,48),(32,50),(33,51),(33,52),(36,54),(38,56),(39,57),(40,58),(40,59),(40,60),(41,61),(42,62),(42,63),(43,64),(44,65),(44,66);
...
-- Dump completed on 2021-05-12 20:16:53
